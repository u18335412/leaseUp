...
const createUnitSchema = z.object({
  ...
  name: z.string().min(1, { message: 'Please enter a unit name' }),
  numberOfBeds: z
    .number()
    .min(1, { message: 'Please enter a number of bedrooms' }),

  numberOfBaths: z
    .number()
    .min(1, { message: 'Please enter a number of bathrooms' }),
  rent: z.number().min(1, { message: 'Please enter a rent amount' }),
});
